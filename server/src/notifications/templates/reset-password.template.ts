              ...
              <tr>
                <td style="padding:34px 28px;">
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:24px 0;">
                    <tr>
                      <td align="center">
                        <a href="${safeResetUrl}" style="display:inline-block;background:#0d0d0d;color:#F4F0E8;text-decoration:none;padding:14px 30px;border-radius:2px;font-size:15px;font-weight:700;">إعادة تعيين كلمة المرور</a>
                      </td>
                    </tr>
                  </table>
