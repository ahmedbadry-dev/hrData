        ...
        <tr>
          <td align="center">
            ...
            ">
              ...
              <tr>
                <td style="
                  background: linear-gradient(160deg, #1f0d0d 0%, #2d0f0f 60%, #1a0a0a 100%);
                ...
                ">
                  ...
                  <p style="
                    ...
                    font-size: 14px;
                    line-height: 1.5;
                  ">We received a request to reset your ETBS password</p>
                </td>
              </tr>
              ...
              <tr>
                <td style="padding: 40px 40px 32px;">
                  ...
                  <p style="
                    ...
                    line-height: 1.8;
                  ">
                    We received a request to reset the password for your ETBS
                      ...
                      <td align="center" style="padding-bottom: 32px;">
                        <a
                          ...
                          style="
                            ...
                            padding: 16px 52px;
                            border-radius: 12px;
                            box-shadow: 0 4px 18px rgba(239, 68, 68, 0.30);
                          "
                        >🔑 &nbsp;Reset My Password</a>
                      </td>
                    </tr>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
                          <tr>
                            ...
                            ">
                              ...
                              <strong style="color: #d4a017;">1 hour</strong>.
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
                          <tr>
                            ...
                            <td style="
                              ...
                              vertical-align: middle;
                            ">
                              If you didn't request this reset, your account may be
                              at risk. Please secure your account immediately.
                            </td>
                          </tr>
                        </table>
                      </td>
