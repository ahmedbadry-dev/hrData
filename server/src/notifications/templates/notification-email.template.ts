            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:620px;background:#f5f0e8;border:2px solid #0d0d0d;border-radius:4px;overflow:hidden;">
              <tr>
                <td style="padding:30px 28px;border-bottom:2px solid #0d0d0d;background:#ede8dc;text-align:center;">
                  <div style="font-size:34px;font-weight:900;letter-spacing:-0.8px;text-align:right;">HR Data<span style="color:#c0392b;">.</span></div>
                  <p style="margin:8px 0 0;font-size:12px;color:#a89880;font-weight:700;text-align:right;">إشعار جديد من المنصة</p>
                </td>
              </tr>
              ...
              <tr>
                <td style="padding:34px 28px;">
                  ...
                  <p style="margin:0 0 12px;font-size:15px;line-height:1.9;color:#0d0d0d;direction:ltr;text-align:right;">مرحباً ${safeRecipientName}</p>
