...
export default function AdminAnalyticsSection() {
  ...
  return (
    <section>
      <div className={styles['section-eyebrow']}>التحليلات</div>
      <div className={styles['section-headline']}>التحليلات المتقدمة</div>

      <div className={styles['stats-grid']}>
        <div className={styles['stat-card']}>
          <div className={styles['stat-val']}>{total}</div>
          <div className={styles['stat-tit']}>إجمالي التقديمات</div>
        </div>
        <div className={styles['stat-card']}>
        ...
        <div className={styles['stat-card']}>
          <div className={styles['stat-val']}>{auto}</div>
          <div className={styles['stat-tit']}>نجاح الآلي</div>
        </div>
        <div className={styles['stat-card']}>
          <div className={styles['stat-val']}>{active}</div>
          <div className={styles['stat-tit']}>مستخدمون نشطون</div>
        </div>
      </div>
