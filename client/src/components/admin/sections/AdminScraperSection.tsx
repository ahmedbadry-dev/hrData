...
import type { ScraperLog } from './adminData';
...
export default function AdminScraperSection({
  ...
  return (
    <section>
      <div className={styles['section-eyebrow']}>السكراب</div>
      <div className={styles['section-headline']}>إدارة السكراب</div>

      <div className={`${styles['scraper-card']} ${scraperRunning ? styles.running : styles.stopped}`}>
        <div className={styles['scraper-head']}>
          <div className={styles['status-col']}>
            <div className={styles['status-mini']}>الحالة الحالية</div>
            <div className={`${styles['scraper-status-big']} ${scraperRunning ? styles.running : styles.stopped}`}>
          ...
          <div>
            <button
              className={`${styles['toggle-scraper-btn']} ${scraperRunning ? styles.stop : styles.start}`}
      ...
      <div className={styles['api-token-box']}>
        ...
        <div className={`${styles['token-status-row']} ${savedToken ? styles.saved : styles.missing}`}>
      ...
      <div className={styles['chart-box']}>
        ...
        {[
          ...
          <div className={styles['source-row']} key={src.name}>
            ...
            <span className={`${styles['status-badge']} ${src.status ? styles.active : styles.suspended}`}>
